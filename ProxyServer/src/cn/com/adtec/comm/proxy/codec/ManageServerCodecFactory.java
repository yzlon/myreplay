...
public class ManageServerCodecFactory implements ProtocolCodecFactory{
	private SoapDecoder decoder;
	private ManageServerEncoder encoder;
	
	public ManageServerCodecFactory(){
		this(Charset.defaultCharset());
	}
	public ManageServerCodecFactory(Charset defaultCharset) {
